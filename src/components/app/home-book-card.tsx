...
export function HomeBookCard({
  ...
  return (
    <Link
      ...
      className={cn(
        "group border-border/80 bg-card focus-visible:ring-ring focus-visible:ring-offset-background flex flex-none gap-4 overflow-hidden rounded-2xl border p-3 transition-[scale,translate,box-shadow] duration-[380ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] outline-none hover:shadow-[0_22px_40px_-12px_rgba(0,0,0,0.5)] focus-visible:ring-2 focus-visible:ring-offset-2 motion-safe:hover:-translate-y-2 motion-safe:hover:scale-[1.05] sm:p-4",
        className,
      )}
    >
