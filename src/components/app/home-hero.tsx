...
/** Sentence/word totals for one lesson, keyed by `${mode}:${lessonId}` — see (dashboard)/[mode]/page.tsx, which derives this once from the same lesson content it already fetches for the lesson list, no extra queries. Also consumed by HomeHeaderBar for its Sessions/Lines/Words tiles (see that component's own doc comment). */
 ...
 * moved to HomeHeaderBar at the top of the page (see that component's own
...
export function HomeHero({
  ...
  return (
    <div className="mb-10 grid gap-4 lg:grid-cols-2 lg:items-stretch">
      ...
      */}
      <div className="border-border bg-card flex flex-col overflow-hidden rounded-2xl border transition-[transform,box-shadow] duration-[380ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:shadow-[0_0_28px_6px_color-mix(in_oklch,var(--primary)_55%,transparent),0_22px_40px_-12px_rgba(0,0,0,0.5)] motion-safe:hover:-translate-y-2 motion-safe:hover:scale-[1.05]">
        {currentLesson && (
          <MainLessonCardBody
      ...
      <div className="flex flex-col gap-4">
        ...
        <Link
          href="/learn/stories"
          className="group border-border bg-card focus-visible:ring-ring focus-visible:ring-offset-background flex flex-1 flex-col overflow-hidden rounded-2xl border transition-[transform,box-shadow] duration-[380ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] outline-none hover:shadow-[0_0_28px_6px_color-mix(in_oklch,var(--primary)_55%,transparent),0_22px_40px_-12px_rgba(0,0,0,0.5)] focus-visible:ring-2 focus-visible:ring-offset-2 motion-safe:hover:-translate-y-2 motion-safe:hover:scale-[1.05]"
        >
