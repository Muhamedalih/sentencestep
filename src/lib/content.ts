 ...
 */
export async function getLessons(mode: LearningMode): Promise<LessonUnit[]> {
...
export async function getAllLessons(): Promise<Record<LearningMode, LessonUnit[]>> {
...
export function findNextLesson(units: LessonUnit[], currentId: string): LessonUnit | undefined {
