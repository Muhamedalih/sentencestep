...
export const en: Dictionary = {
  ...
  countryOnboarding: {
    heading: "Which country do you use the app from?",
  ...
  settings: {
    ...
    pushNotificationsTestButton: "Send test notification",
    pushNotificationsTestSending: "Sending…",
    pushNotificationsTestSent: "Sent! Check your notifications.",
  ...
  bookLibrary: {
    ...
    monthlyChallengeHeading: "Read {goal} books this month",
    monthlyChallengeCompleteHeading: "You hit this month's reading goal!",
    completedBooksHeading: "Books You've Completed",
    booksTabLabel: "Books",
    novelsTabLabel: "Novels",
    novelsHeading: "Novels",
    novelsSubtitle: "Classic stories, retold as focused reading practice.",
    novelsDisclaimer:
      "These are personal reading summaries of classic novels, retold in my own words — not the original full text, and not an official or licensed edition. Cover art, where shown, is used only to identify the work and remains the property of its respective rights holders.",
    allNovelsHeading: "All Novels",
    completedNovelsHeading: "Novels You've Completed",
    novelsEmptyHeading: "The novels shelf is just getting started",
    novelsEmptyBody: "We're preparing the first novel summaries — check back soon.",
    ...
    rateStarsLabel: "Rate {n} stars",
    ratingCountLabel: "{count} ratings",
    signInToRate: "Sign in to rate this book",
    practice: "Practice",
