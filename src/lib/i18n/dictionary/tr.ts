...
export const tr: Dictionary = {
  ...
  lesson: {
    ...
    backToStoriesLibrary: "Ana Sayfa",
  ...
  settings: {
    ...
    pushNotificationsTestButton: "Test bildirimi gönder",
    pushNotificationsTestSending: "Gönderiliyor…",
    pushNotificationsTestSent: "Gönderildi! Bildirimlerinizi kontrol edin.",
  ...
  bookLibrary: {
    ...
    recommendedHeading: "Size Özel Öneriler",
    ...
    monthlyChallengeHeading: "Bu ay {goal} kitap oku",
    monthlyChallengeCompleteHeading: "Bu ayki okuma hedefine ulaştın!",
    completedBooksHeading: "Tamamladığın Kitaplar",
    booksTabLabel: "Kitaplar",
    novelsTabLabel: "Romanlar",
    novelsHeading: "Romanlar",
    novelsSubtitle: "Klasik hikayeler, odaklı okuma pratiği olarak yeniden anlatıldı.",
    novelsDisclaimer:
      "Bunlar, klasik romanların kendi cümlelerimle yeniden anlatılmış kişisel okuma özetleridir — orijinal tam metin veya resmi/lisanslı bir baskı değildir. Gösterilen kapak görselleri yalnızca eseri tanımlamak amacıyla kullanılır ve ilgili hak sahiplerinin mülkiyetinde kalır.",
    allNovelsHeading: "Tüm Romanlar",
    completedNovelsHeading: "Tamamladığın Romanlar",
    novelsEmptyHeading: "Roman rafı yeni başlıyor",
    novelsEmptyBody: "İlk roman özetlerini hazırlıyoruz — yakında tekrar gelin.",
    ...
    yourRatingLabel: "Puanınız",
    rateStarsLabel: "{n} yıldız ver",
    ratingCountLabel: "{count} değerlendirme",
    signInToRate: "Bu kitabı puanlamak için giriş yapın",
