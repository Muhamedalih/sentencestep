...
export const es: Dictionary = {
  common: {
    ...
    resumeLesson: "Continúa donde lo dejaste",
    save: "Guardar",
    saved: "Guardado",
    cancel: "Cancelar",
  ...
  settings: {
    ...
    pushNotificationsTestButton: "Enviar notificación de prueba",
    pushNotificationsTestSending: "Enviando…",
    pushNotificationsTestSent: "¡Enviada! Revisa tus notificaciones.",
  ...
  vocabularyRecall: {
    ...
    cardSubtitle: "Mira cómo las usaste en tus propias oraciones",
  ...
  bookLibrary: {
    ...
    recommendedHeading: "Recomendado para ti",
    ...
    monthlyChallengeHeading: "Lee {goal} libros este mes",
    monthlyChallengeCompleteHeading: "¡Cumpliste tu meta de lectura de este mes!",
    completedBooksHeading: "Libros que has completado",
    booksTabLabel: "Libros",
    novelsTabLabel: "Novelas",
    novelsHeading: "Novelas",
    novelsSubtitle: "Historias clásicas, adaptadas como práctica de lectura enfocada.",
    novelsDisclaimer:
      "Estos son resúmenes personales de lectura de novelas clásicas, recontados con mis propias palabras — no el texto completo original, ni una edición oficial o con licencia. Las imágenes de portada, cuando se muestran, se usan únicamente para identificar la obra y siguen siendo propiedad de sus respectivos titulares de derechos.",
    allNovelsHeading: "Todas las novelas",
    completedNovelsHeading: "Novelas que has completado",
    novelsEmptyHeading: "La sección de novelas recién comienza",
    novelsEmptyBody: "Estamos preparando los primeros resúmenes de novelas — vuelve pronto.",
    ...
    rateStarsLabel: "Valorar con {n} estrellas",
    ratingCountLabel: "{count} valoraciones",
    signInToRate: "Inicia sesión para valorar este libro",
    practice: "Practicar",
