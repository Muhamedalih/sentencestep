...
export default async function LearnNotFound() {
  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col items-center gap-4 px-6 py-24 text-center sm:py-32">
      ...
      <h1 className="text-2xl font-semibold tracking-tight">{t.errors.lessonNotFoundHeading}</h1>
      <p className="text-muted-foreground max-w-sm">{t.errors.lessonNotFoundBody}</p>
      <Button asChild className="mt-2">
        <Link href="/learn">{t.errors.backToDashboard}</Link>
      </Button>
    </div>
  );
}
